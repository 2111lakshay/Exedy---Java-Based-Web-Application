...
<body>
	...
	<div class="add-button">
	 <a href="AddProduct.jsp?userid=<%=request.getParameter("userid") != null ? Integer.parseInt(request.getParameter("userid")) : ""%>" style="background-color: blue;">Add</a>

	  
	 </div>
	 <div class="exit-button">
	 	
		<a href="Login.jsp" style="background-color: red;">Exit</a>
	</div>
  ...
  <% if (currentPage > 1) { %>
    <a href="?page=<%=currentPage - 1%>&userid=<%=request.getParameter("userid")%>">&laquo; Previous</a>
  <% } %>

  <% for (int i = 1; i <= totalPages; i++) { %>
    <% if (i == currentPage) { %>
      <a href="?page=<%=i%>&userid=<%=request.getParameter("userid")%>" class="active"><%=i%></a>
    <% } else { %>
  ...
  <% if (currentPage < totalPages) { %>
    <a href="?page=<%=currentPage + 1%>&userid=<%=request.getParameter("userid")%>">Next &raquo;</a>
  <% } %>
</div>
